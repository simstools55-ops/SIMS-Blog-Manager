...
function sbmDoctorSubmitSiteDiagnosisResultChunk(rawText,startIndex){
  try{
    ...
    if(caseResults.length>1)return sbmDoctorProcessCaseResultBatchChunk_(caseResults,startIndex,2);
