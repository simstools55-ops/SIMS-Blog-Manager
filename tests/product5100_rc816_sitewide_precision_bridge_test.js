...
const sample={format:'SIMS_DOCTOR_SITE_WIDE_PRECISION_RESULT_V1',site_diagnosis_batch_id:'SITEWIDE-X',site_id:'windinglife55',clusters:[
 {diagnosis_case_id:'C1',request_id:'C1',diagnosis_theme:'NHK',cluster_result:{diagnosis_summary:'x',confidence:'85%',sub_groups:[{group_type:'CANNIBALIZATION',route_to:'WRITER',treatment_strategy:'NORMAL_REWRITE',articles:[{site_id:'windinglife55',article_id:'A000005',article_url:'https://x/5'},{site_id:'windinglife55',article_id:'A000003',article_url:'https://x/3'}]},{group_type:'NORMAL_HUB_AND_SPOKE',route_to:'MONITOR',treatment_strategy:'WAIT',articles:[{site_id:'windinglife55',article_id:'A000006',article_url:'https://x/6'}]}]},workflow_handoff:{next_action:'WRITER',allowed_scope:['trim'],blocked_scope:[]}},
 {diagnosis_case_id:'C2',request_id:'C2',diagnosis_theme:'獅子舞',cluster_result:{diagnosis_summary:'merge',confidence:'85%',route_to:'MERGE',treatment_strategy:'NORMAL_REWRITE',merge_plan:{target_article:{site_id:'windinglife55',article_id:'A000059',article_url:'https://x/59'},source_article:{site_id:'windinglife55',article_id:'A000057',article_url:'https://x/57'},redirect_direction:'A000057 -> A000059'}},workflow_handoff:{next_action:'MERGE',allowed_scope:['absorb'],blocked_scope:[]}},
 {diagnosis_case_id:'C3',request_id:'C3',diagnosis_theme:'ハイタッチ',cluster_result:{diagnosis_summary:'no cannibal',confidence:'85%',route_to:'NO_ACTION',treatment_strategy:'LIGHT_FIX',articles:[{site_id:'windinglife55',article_id:'A000019',article_url:'https://x/19'},{site_id:'windinglife55',article_id:'A000008',article_url:'https://x/8'}]},workflow_handoff:{next_action:'WRITER',allowed_scope:['internal link'],blocked_scope:['merge']}}
]};
...
ok(units[2].doctor.article_id==='A000059','Merge representative is target article');
ok(units[2].doctor.merge_direction==='A000057 -> A000059','Merge direction preserved');
