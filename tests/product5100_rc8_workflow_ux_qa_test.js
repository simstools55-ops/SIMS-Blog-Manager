...
ok(code.includes("setValue('現在地')")&&code.includes("merge().setValue('精密診断する記事を選ぶ')"),'referral current-position guide');
ok(code.includes("merge().setValue('Doctor診断・処置の進行確認')"),'diagnosis status current-position guide');
