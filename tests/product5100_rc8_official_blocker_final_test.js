...
ok(code.includes("var visible={'選択':1,'改善日':1,'記事タイトル':1,'改善概要':1,'改善経路':1,'1週':1,'2週':1,'3週':1,'4週':1,'最終判定':1,'状態':1};"), 'unused AI column is excluded from the visible history view');
