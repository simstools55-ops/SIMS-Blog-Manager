...
const required = [
  ...
  "SIMS_DOCTOR_EVIDENCE_PACKAGE_V1",
...
if (code !== dist) throw new Error('Code.gs and distribution/コード.gs differ');
JSON.parse(fs.readFileSync(path.join(root, 'contracts', 'schemas', 'SIMS_DOCTOR_SINGLE_CASE_REQUEST_V2.schema.json'), 'utf8'));
console.log('Doctor Evidence Package static test: PASS');
