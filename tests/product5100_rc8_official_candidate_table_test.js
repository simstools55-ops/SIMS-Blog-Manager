...
ok(code.includes("filter(function(r){return sbmDoctorIsUntreatedCurrentCandidate_"),'only untreated articles rendered');
...
ok(code.includes("cand.getRange(7,3,out.length,6).setWrap(false)"),'rows remain compact without vertical expansion');
