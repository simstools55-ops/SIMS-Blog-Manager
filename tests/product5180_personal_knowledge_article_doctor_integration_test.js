...
must(code.includes("const SBM_VERSION = '5.18.0'"),'version');
must(code.includes("sbmPersonalKnowledgeIngestPayload_(doctor,'SIMS Article Doctor')"),'Article Doctor ingestion missing');
