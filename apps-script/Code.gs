...
function sbmFetchSearchConsolePageRowsForArticleDb_(profiler) {
  ...
  return {rawRows: rows.length, rows: out, excluded: excluded, fragmentCount: fragmentCount, timings:timings};
}
